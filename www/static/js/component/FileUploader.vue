<template>
  <div class="example-full">
    ...
    <div v-bind:class="{'modal-backdrop': true, 'fade': true, show: addData.show}"></div>

    <div
      v-bind:class="{modal: true, fade: true, show: addData.show}"
      id="modal-add-data"
      tabindex="-1"
      role="dialog"
    >
    ...
    <div v-bind:class="{'modal-backdrop': true, 'fade': true, show: editFile.show}"></div>
    <div
      v-bind:class="{modal: true, fade: true, show: editFile.show}"
      id="modal-edit-file"
      tabindex="-1"
      role="dialog"
    >
